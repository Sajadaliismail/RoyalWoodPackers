  ...
  return (
    ...
    >
      <g transform="matrix(0.1,0,0,-0.1,0,1836)" fill="#000000" stroke="none">
        <path
          className="svg1 fill-slate-950 dark:fill-slate-200 "
        ...
        />
        <path
          className="svg5  fill-slate-950 dark:fill-slate-200"
        ...
        />
        <path
          className="svg6  fill-slate-950 dark:fill-slate-200"
          //   className="svg-elem-6"
          d="m 22164.26,1184.6458 h 3124.103 l -7.999,6518.544 z"
        />
        <path
          className="svg7 fill-[#182d55] dark:fill-sky-700"
