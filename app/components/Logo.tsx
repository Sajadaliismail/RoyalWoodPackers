  ...
  return (
    ...
    >
      <g transform="matrix(0.1,0,0,-0.1,0,1836)" fill="#000000" stroke="none">
        <path
          className="svg1  fill-[#181818] dark:fill-slate-200 "
        ...
        />
        <path
          className="svg4   fill-[#181818] dark:fill-slate-200"
        ...
        />
        <path
          className="svg5   fill-[#181818] dark:fill-slate-200"
        ...
        />
        <path
          className="svg6   fill-[#181818] dark:fill-slate-200"
