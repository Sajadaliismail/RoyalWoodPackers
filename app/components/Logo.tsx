  ...
  useGSAP(() => {
    ...
    if (svgRef.current) {
      ...
      tl.fromTo(
        ...
        { x: 0, opacity: 1, ease: "power3", duration: 0.15 }
      );
      tl.fromTo(
      ...
      tl.fromTo(
        ...
        { x: 2800, opacity: 1, ease: "elastic.inOut", duration: 0.3 }
      );
      tl.fromTo(
