...
export const BoxRates: React.FC<boxInfoProps> = ({ formData }) => {
            ...
            <tbody>
              <tr className="hover:bg-slate-700  transition-colors duration-200">
                ...
                <td className="p-2 rounded-r-md">
                  {boxData.type === "wood" ? "Wooden Box" : "Plywood Box"}
                </td>
              </tr>
              <tr className="hover:bg-slate-700  transition-colors duration-200">
            ...
            <table className="w-full text-gray-200">
              <tbody>
                ...
                <tr className="hover:bg-slate-700  transition-colors duration-200">
                  ...
                  <td className="p-2 rounded-r-md">
                    {boxData.nettyBoardLength} mm x {boxData.nettyBoardWidth} mm
  ...
  <p className="text-gray-100">
    We appreciate your interest and will get back to you soon with the rates.
  </p>
          </div>
        )}
      </div>
